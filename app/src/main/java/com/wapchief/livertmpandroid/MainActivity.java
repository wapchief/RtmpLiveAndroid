...
public class MainActivity extends AppCompatActivity {
    ...
    TXCloudVideoView mVideoView,mVideoViewM3U8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoViewM3U8 = (TXCloudVideoView) findViewById(R.id.video_view1);
        mVideoView = (TXCloudVideoView) findViewById(R.id.video_view);
        mDanmakuView = (DanmakuView) findViewById(R.id.danmaku);
        mSwitchCompat = (SwitchCompat) findViewById(R.id.switch_bt);
        initView();
        initViewM3U8();
    }

    private void initViewM3U8() {
        //创建 player 对象
        TXLivePlayer mLivePlayer = new TXLivePlayer(this);
        //关键 player 对象与界面 view
        mLivePlayer.seek(100);
        mLivePlayer.setPlayerView(mVideoViewM3U8);
        mLivePlayer.startPlay(URL_M3U8, TXLivePlayer.PLAY_TYPE_VOD_HLS);
    }
